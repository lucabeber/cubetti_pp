...
file_name = "/grigio_3_s_22";
[el1,~] = elastic_parameters_multiple(file_name,0.5,260)

file_name = "/grigio_3_d_22";
[el2,~] = elastic_parameters_multiple(file_name,0.5,260)

file_name = "/grigio_4_s_22";
[el3,~] = elastic_parameters_multiple(file_name,0.5,260)

file_name = "/grigio_4_d_22";
[el4,~] = elastic_parameters_multiple(file_name,0.5,260)
%%
...
file_name = "/grigio_3_s_15";
[el1,~] = elastic_parameters_multiple(file_name,0.5,260)

file_name = "/grigio_3_d_15";
[el2,~] = elastic_parameters_multiple(file_name,0.5,260)

file_name = "/grigio_4_s_15";
[el3,~] = elastic_parameters_multiple(file_name,0.5,260)

file_name = "/grigio_4_d_15";
[el4,~] = elastic_parameters_multiple(file_name,0.5,260)
...
% file_name = "/grigio_3_s_0";
% [el1,~] = elastic_parameters_multiple(file_name,0.5,260)

file_name = "/grigio_3_d_0";
[el2,~] = elastic_parameters_multiple(file_name,0.5,260)

file_name = "/grigio_4_s_0";
[el3,~] = elastic_parameters_multiple(file_name,0.5,260)

file_name = "/grigio_4_d_0";
[el4,~] = elastic_parameters_multiple(file_name,0.5,260)

%%
% time = [0:15:15*19,0:15:15*19,0:15:15*19];
% el = [el1,el2,el3];
time = [0:14:14*19,0:14:14*19];
el = [el2,el3];
model = fit(time',el','exp2')
